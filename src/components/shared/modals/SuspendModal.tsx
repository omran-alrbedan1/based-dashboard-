          ...
          <form onSubmit={form.handleSubmit(handleSubmit)}>
            <DialogHeader>
              <div className="flex items-center gap-3 rtl:text-start">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-red-500/20 to-red-500/10">
                  <Ban className="h-5 w-5 text-red-600" />
                </div>
                <div className="space-y-1">
                  <DialogTitle className="text-xl">{t('modals.suspend.title')}</DialogTitle>
                  <DialogDescription>
